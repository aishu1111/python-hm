...
# main block
fDict = dictionary_from_FASTA_file('rosalind_cons.txt')
seqList = fDict.values()
print consensus_string_dna(profile_matrix_dna(seqList))
print "A: " +  convert(profile_matrix_dna(seqList)[0])
print "C: " +  convert(profile_matrix_dna(seqList)[1])
print "G: " +  convert(profile_matrix_dna(seqList)[2])
print "T: " +  convert(profile_matrix_dna(seqList)[3])